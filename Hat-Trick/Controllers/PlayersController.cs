...
namespace Hat_Trick.Controllers
{
    public class PlayersController : Controller
    {
        ...
        {
            var players = db.Players.Include(p => p.Club).Include(p=>p.Country);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Image,Name,Age,Position,ClubId,CountryId")] Player player, HttpPostedFileBase ImageFile)
        {
            using (var ms = new MemoryStream())
            {
                ImageFile.InputStream.CopyTo(ms);
